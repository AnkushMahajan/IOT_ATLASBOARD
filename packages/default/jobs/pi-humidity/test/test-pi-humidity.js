/**
 * Test file for Job: pi-humidity
 */

var assert = require ('assert');
var pi_humidity_SUT = require('../pi-humidity');

var mockedConfig, mockedDependencies;

describe ('pi-humidity test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      pi_humidity_SUT.onRun(config, mockedDependencies, function(err, data){

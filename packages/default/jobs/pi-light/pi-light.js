...
module.exports = {
  ...
  onInit: function (config, dependencies) {
     ...
     */
      ...
      console.log('Hey Connected to IOT - RASPBERRY PI -- for message lightmeter');
      device.subscribe('lightmeter');
      stfuEnabled = false;
  ...
  onRun: function (config, dependencies, jobCallback) {
      ...
      var mailOptions = {
          from: '"You have been notified of the light reading"<' + emailSenderId + '>', // sender address
          to: '',
          subject: 'Light Reading has gone down in your office', // Subject line
          text: 'Light reading in office', // plaintext body

/**
 * Test file for Job: pi-light
 */

var assert = require ('assert');
var pi_light_SUT = require('../pi-light');

var mockedConfig, mockedDependencies;

describe ('pi-light test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      pi_light_SUT.onRun(config, mockedDependencies, function(err, data){

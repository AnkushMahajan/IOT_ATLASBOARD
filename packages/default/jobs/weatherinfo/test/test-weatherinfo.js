/**
 * Test file for Job: weatherinfo
 */

var assert = require ('assert');
var weatherinfo_SUT = require('../weatherinfo');

var mockedConfig, mockedDependencies;

describe ('weatherinfo test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      weatherinfo_SUT.onRun(config, mockedDependencies, function(err, data){
